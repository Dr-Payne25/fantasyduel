...
def create_demo_data():
    ...
    try:
        ...
        if not demo_league:
            ...
            print(f"✅ Created demo league - Name: Demo League 2025, ID: {demo_league.id}")
        else:
            print(f"ℹ️  Demo league already exists - Name: {demo_league.name}, ID: {demo_league.id}")
        ...
        for i in range(1, 10):
            ...
            if not user:
                ...
                print(f"✅ Created test user - Username: {username}, Password: password123")
